...
// Sphere - shape is the same value as THREEJS sphere to match physics response to visual size
...
// Push the sphere like a cannon shot
...
const tick = () => {
  ...
  // Apply force to sphere, like a constant wind applied to the center of the sphere
  ...
  // Apply physics to THREEJS objects
  //   sphere.position.x = sphereBody.position.x;
  //   sphere.position.y = sphereBody.position.y;
  //   sphere.position.z = sphereBody.position.z;

  // written simpler is to COPY because THREEJS uses Vector3 and CANNON uses Vec3, which work the same
